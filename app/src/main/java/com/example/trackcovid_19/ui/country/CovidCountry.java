...
public class CovidCountry implements Parcelable {
    String mCovidCountry, mCases, mTodayCases, mDeaths, mTodayDeaths, mRecovered, mActiveCritical, mCritical;

    public CovidCountry(String mCovidCountry, String mCases, String mTodayCases, String mDeaths, String mTodayDeaths, String mRecovered, String mActiveCritical, String mCritical) {
        ...
        this.mActiveCritical = mActiveCritical;
    ...
    public String getmActiveCritical() {
        return mActiveCritical;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.mActiveCritical);
    ...
    protected CovidCountry(Parcel in) {
        ...
        this.mActiveCritical = in.readString();
